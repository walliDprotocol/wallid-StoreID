...
var storeBlockId = {
	...
	addInfo:function(importId, callback) {
		return db.query("INSERT INTO user_information (wallet_signature, sod, certificate, user_wallet) VALUES (?, ?, ?, ?)",[importId.wallet_signature, importId.sod, importId.certificate, importId.wallet_address], callback);
	}
};
